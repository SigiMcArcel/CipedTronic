...
#define STR_MANUFACTURER	L"Cipedtronic"
#define STR_PRODUCT		L"Tacho"
#define STR_SERIAL_NUMBER	L"01"
#define VENDOR_ID		0x2341 // must match INF file in Windows
#define PRODUCT_ID		0x8036 // must match INF file in Windows
